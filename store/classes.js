export const state = () => ({
  ...
  classes: {
    barbarian: [
      ...
      {
        text:
          'I went on a spiritual journey to find myself and instead found a s pirit animal to guide, protect, and inspire me.'
      },
      {
        text:
          'I was struck by lightning and lived. Afterward, I fou nd a new strength within me that let me push beyond my limitations.'
      },
      {
        text:
    ...
    bard: [
      ...
      {
        text:
          'I picked up a musical instrument o ne day and instantly discovered that I could play it.'
      }
    ],
    cleric: [
      {
        text:
          'A supernatu ral being in service to the gods called me to become a divine agent in the world.'
      },
      {
        text:
      ...
      {
        text:
          "Although I was a lways devout, it wasn' t until I completed a pilgrimage that I knew my true calling."
      },
      {
        text:
          "I used to serve in my religion's bureaucracy but found I needed to wo rk in the world , to bring the message of my faith to the darkest corners of the land."
      },
      {
        text:
    ...
    druid: [
      ...
      {
        text:
          'I found a place a mong a group of druids after I fled a catastrophe.'
      },
      {
        text:
          'I have always had an affin ity for animals, so I explored my talent to see how I could best use it.'
      },
      {
        text:
      ...
      {
        text:
          'I have always felt disgust for cre atures of unnatural origin. For this reason, I immersed myself in the study of the druidic mysteries and became a champion of the natural order.'
      }
    ],
    fighter: [
      {
      ...
      {
        text:
          'I squired for a knight who taught me how to fight, care for a steed , and conduct myse lf with honor. I decided to take up that path for myself.'
      },
      {
        text:
      ...
      {
        text:
          'I could always pick up just about a ny weapon and know how to use it effectively.'
      }
    ],
    monk: [
      {
        text:
          'I was chosen to study at a secluded monastery. There, I was tau ght the fundamental techniques required to eventually master a tradition.'
      },
      {
        text:
          'I sought instruction to gain a deeper unders t anding of existence a nd my place in the world.'
      },
      {
        text:
          'I stmbled into a portal to the Shadowfell and took refuge in a strange monastery, where I learned how to defend myself against the forces of darkness.'
      },
      {
        text:
      ...
      {
        text:
          'I could feel that a special sort of power la y within me, so I sought out those who could help me call it forth and master it.'
      },
      {
        text:
          'I was wild and undisciplined as a you ngster, but then I realized the error of my ways. I applied to a monastery and became a monk as a way to live a life of discipline.'
      }
    ],
    paladin: [
      {
      ...
      {
        text:
          'The world is a dark and terrible place. I decided to serve as a beacon oflight shining out against the gathering shadows.'
      },
      {
        text:
          "I served as a paladin's squ ire, learning all I needed to swear my own sacred oath."
      },
      {
        text:
      ...
      {
        text:
          'Becoming a paladin was a natural consequence of my unwavering fa ith. In taking my vows, I became the holy sword of my religion.'
      }
    ],
    ranger: [
      {
    ...
    rogue: [
      ...
      {
        text:
          "I'm a sucker fo r a shiny bauble or a sack of coins, as long as I can get my hands on it without risking life and limb."
      }
    ],
    sorcerer: [
      {
      ...
      {
        text:
          'Is uffered a terrible emotional or phys ical strain, which brought forth my latent magical power. I have fought to control it ever since.'
      },
      {
        text:
      ...
      {
        text:
          'After I escaped from a magical conAagration, I realized that though I was unharmed, I was not unchanged. I began to exhibit unusual abil ities that I am just beginning to understand.'
      }
    ],
    warlock: [
      {
      ...
      {
        text:
          'I stumbled into the clutches of my patron after I accidenta lly stepped through a magical doorway.'
      },
      {
        text:
      ...
      {
        text:
          'My future patron vis ited me in my dreams and offered great power in exchange for my service.'
      },
      {
        text:
          'One of my ancestors had a pact with my patron, so t hat entity was determined to bind me to the same agreement.'
      }
    ],
    wizard: [
      {
